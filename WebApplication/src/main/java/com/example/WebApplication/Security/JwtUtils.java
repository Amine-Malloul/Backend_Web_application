...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        // Generate a JWT token with the user's username, issued date, expiration date, and sign it with the secret key
        return Jwts.builder()
    ...
    public String getUserNameFromJwtToken(String token) {
        // Parse the JWT token and extract the username from the token's body
